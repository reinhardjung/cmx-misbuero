...
function cmx_render_stammdaten_metabox(\WP_Post $post) {
	...
	echo '	</label><br>
		<input id="cmx_hr_uid" name="cmx_hr_uid" type="text" class="text" placeholder="CHE-123.456.789" inputmode="numeric" value="' . \esc_attr($hr_uid) . '">
	</p>';
...
(function(){
	...
	function formatHrUid(value) {
		...
		return parts.length ? "CHE-" + parts.join(".") : "";
	}
