...
if (!\function_exists(__NAMESPACE__ . '\\cmx_kl_render_box_kontakte')) {
	function cmx_kl_render_box_kontakte(\WP_Post $post): void {
		...
		echo '<div class="cmx-kl-preview-empty" style="' . ($has_image ? 'display:none;' : 'display:block;') . 'color:#646970;font-style:italic;text-align:center;">Kein ' . \esc_html($label) . ' vorhanden.<br>Dateien hier ablegen oder klicken.<br>PNG-Format: 1920x1080px</div>';
