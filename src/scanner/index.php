...
register_post_type(basename(__DIR__), ['labels' => ['name' => 'Poststelle', 'singular_name' => 'Poststelle', 'add_new_item' => 'Hinzufügen', 'edit_item' => 'Bearbeiten',],
	'menu_position' => 95, 'supports' => ['title', 'editor'], 'public' => true, 'menu_icon' => 'dashicons-buddicons-pm', 'show_in_rest' => true, 'has_archive' => true, 'rewrite' => ['slug' => basename(__DIR__)],
]);
...
cmx_require_files(__DIR__, 'zuordnung,zuordnung_kontakte,zuordnung_artikel,zuordnung_dokumente,zuordnung_projekte,zuordnung_belege,admincolumnslist,import_camt');  // ,import_mails
