...
register_post_type(basename(__DIR__), ['labels' => ['name' => cmx_sani_key(basename(__DIR__), 'title'), 'singular_name' => cmx_sani_key(basename(__DIR__), 'title'), 'add_new_item' => 'Hinzufügen', 'edit_item' => 'Bearbeiten',],
	'menu_position' => 40, 'supports' => ['title'], 'public' => true, 'menu_icon' => 'dashicons-money', 'show_in_rest' => true, 'has_archive' => true, 'rewrite' => ['slug' => basename(__DIR__)],
]);
...
// cmx_require_files(__DIR__,'kopfdaten,positionen,konditionen,mwst,dokumente,admincolumns,notizen,summen,anzahlungen,vorlage_pdf,meta_action,logfile,vorlage_qr_code,add_tasks');
