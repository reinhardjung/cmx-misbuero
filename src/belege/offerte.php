...
if (!\function_exists(__NAMESPACE__ . '\\cmx_handle_beleg_offerte_public_action')) {
	function cmx_handle_beleg_offerte_public_action(): void {
		...
		$pdf_url = \function_exists(__NAMESPACE__ . '\\cmxbu_get_beleg_public_url')
			? (string) cmxbu_get_beleg_public_url($post_id, $token)
			: (string) \add_query_arg('beleg', $token, \home_url('/'));
