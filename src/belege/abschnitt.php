...
add_filter('cmx_beleg_positionen_render_custom_row', function ($handled, int $i, $pos) {
	...
	echo '<input type="text" class="regular-text cmx-abschnitt-titel" name="cmx_positionen[' . $i . '][abschnitt_titel]" value="' . \esc_attr($titel) . '" placeholder="Abschnitt" style="width:calc(100% - 79px); margin-left:20px; box-sizing:border-box;">';
	...
	echo '<textarea class="cmx-abschnitt-text" name="cmx_positionen[' . $i . '][abschnitt_text]" rows="2" placeholder="Beschreibender Text" style="width:calc(100% - 79px); margin-top:6px; margin-left:20px; box-sizing:border-box;">' . \esc_textarea($text) . '</textarea>';
	echo '</div>';
	echo '</td>';
	echo '</tr>';
				...
				const rowHtml = '' +
							'<tr class="cmx-pos-row cmx-pos-row-abschnitt">' +
								'<td colspan="7" class="cmx-pos-abschnitt-cell">' +
									...
									'<input type="text" class="regular-text cmx-abschnitt-titel" name="cmx_positionen[' + i + '][abschnitt_titel]" value="" placeholder="Abschnitt" style="width:calc(100% - 79px); margin-left:20px; box-sizing:border-box;">' +
									'<div class="cmx-abschnitt-text-wrap">' +
										TEXTBAUSTEIN_EDIT_LINK +
										'<textarea class="cmx-abschnitt-text" name="cmx_positionen[' + i + '][abschnitt_text]" rows="2" placeholder="Beschreibender Text" style="width:calc(100% - 79px); margin-top:6px; margin-left:20px; box-sizing:border-box;"></textarea>' +
									'</div>' +
								'</td>' +
							'</tr>';
