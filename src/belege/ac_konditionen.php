...
if (!function_exists(__NAMESPACE__ . '\\cmx_beleg_admin_richtung_label_map')) {
	function cmx_beleg_admin_richtung_label_map(): array {
		...
		$map = [
			'rechnung' => ['ausgang' => 'Einnahme', 'eingang' => 'Ausgabe'],
			'rechnungen' => ['ausgang' => 'Einnahme', 'eingang' => 'Ausgabe'],
			'gutschrift' => ['ausgang' => 'Ausgabe', 'eingang' => 'Einnahme'],
			'gutschriften' => ['ausgang' => 'Ausgabe', 'eingang' => 'Einnahme'],
			'quittung' => ['ausgang' => 'Einnahme', 'eingang' => 'Ausgabe'],
			'quittungen' => ['ausgang' => 'Einnahme', 'eingang' => 'Ausgabe'],
			'offerte' => ['ausgang' => 'Ausgang', 'eingang' => 'Eingang'],
			'offerten' => ['ausgang' => 'Ausgang', 'eingang' => 'Eingang'],
			'lieferschein' => ['ausgang' => 'Ausgang', 'eingang' => 'Eingang'],
			'lieferscheine' => ['ausgang' => 'Ausgang', 'eingang' => 'Eingang'],
		];
...
$add_columns = function(array $columns){
	...
	$insert = [
		...
		'beleg_zahlungsart' => __('Zahlart', 'cmx'),
		'beleg_zahlungsgrund' => __('Zahlgrund', 'cmx'),
	];
