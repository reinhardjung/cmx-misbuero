...
cmx_require_files(__DIR__,'kopfdaten,positionen,abschnitt,konditionen,offerte,mwst,liste_belege,admincolumns,summen,anzahlungen,anhaenge,vorlage_pdf,factur-x,meta_action,logfile,vorlage_qr_code,add_tasks,exports_data,imports,exports,woocommerce,ext_pdf,abo,eingang');
