			...
			<div class="cmx-abo-metabox">
				...
				<?php if ($stop_url !== '') : ?>
					<p class="cmx-abo-actions">
						<a href="<?php echo \esc_url($stop_url); ?>" class="button button-secondary" onclick="return window.confirm('Wiederkehrenden Versand für diesen Beleg stoppen?');"><?php echo \esc_html__('Stoppen', 'cmx-misbuero'); ?></a>
					</p>
				<?php endif; ?>
