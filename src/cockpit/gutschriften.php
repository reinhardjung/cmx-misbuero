...
/**
 * Dashboard-Widget: Gutschriften
 * Zeigt zwei Kennzahlen:
 * - bezahlt: Anzahl und Summe aller bezahlten Gutschriften
 * - offen:   Anzahl und Summe aller offenen Gutschriften
 */

add_action('wp_dashboard_setup', function () {
	wp_add_dashboard_widget(
		'cmx_gutschriften_widget',
		'Gutschriften',
		__NAMESPACE__ . '\\cmx_render_gutschriften_widget'
	);
});

function cmx_render_gutschriften_widget(): void {
