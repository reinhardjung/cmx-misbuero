...
\add_action('wp_ajax_cmx_carent_fuehrerausweis_upload', function (): void {
	...
	$uploaded = \function_exists(__NAMESPACE__ . '\\cmx_carent_store_contract_uploaded_file')
		? cmx_carent_store_contract_uploaded_file($post_id, (array) $_FILES['file'], 'fuehrerausweis')
		: cmx_dav_store_uploaded_file('carent', (array) $_FILES['file'], 'fuehrerausweise' . ($post_id > 0 ? '/' . $post_id : ''));
