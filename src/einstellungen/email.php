...
\add_action('admin_init', function (): void {
	...
	\add_action('admin_head', function (): void {
		...
		<style>
			...
			.button.cmx-email-client-category-toggle {
				display: inline-flex;
				align-items: center;
				justify-content: center;
				width: 44px;
			...
			.button.cmx-email-client-category-toggle .dashicons {
				display: block;
				width: 24px;
				height: 24px;
				margin: 0;
	...
	if (\trim((string) $new['email_button_text']) === '') {
		$new['email_button_text'] = 'PDF-Beleg herunterladen';
	}
