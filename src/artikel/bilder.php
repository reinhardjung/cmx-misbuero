...
if (!\function_exists(__NAMESPACE__.'\\cmx_li_render_box_artikel')) {
	function cmx_li_render_box_artikel(\WP_Post $post): void {
		...
		echo '<div class="cmx-li-preview-empty" style="' . ($has_image ? 'display:none;' : 'display:block;') . 'color:#646970;font-style:italic;text-align:center;">Kein Artikelbild vorhanden.<br>Dateien hier ablegen oder klicken.<br>PNG-Format: 1920x1080px</div>';
