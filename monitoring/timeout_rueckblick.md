...
Wichtig:
- moeglichst vor einem Server-Neustart ausfuehren
...
Shell-Logs:
- Site-Logs:
  - `/var/www/rentify.misbuero.ch/logs/error.log`
  - `/var/www/rentify.misbuero.ch/logs/access.log`
  - `/var/www/rentify.misbuero.ch/logs/php-error.log`
  - `/var/log/caddy/rentify.misbuero.ch.access.log`
- Systemdienste:
  - `journalctl -u caddy --since "2 hours ago"`
