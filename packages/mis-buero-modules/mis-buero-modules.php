<?php
/**
 * Plugin Name: Mis Büro Modules
 * Description: Optionale Premium-Module für Mis Büro.
 * Version: 1.0.0
 * Author: Mis Büro
...
\CLOUDMEISTER\MisBuero\Core\Autoloader::register([
	...
	'CLOUDMEISTER\\MisBuero\\Modules\\' => __DIR__ . '/src',
]);

add_action('plugins_loaded', static function (): void {
	if (!\CLOUDMEISTER\MisBuero\Core\Helpers::plugin_is_active('mis-buero/mis-buero.php')) {
		\CLOUDMEISTER\MisBuero\Core\Helpers::admin_notice(__('Mis Büro Modules benötigt das aktive Plugin Mis Büro.', 'mis-buero'), 'error');
		return;
	}

	\CLOUDMEISTER\MisBuero\Core\Plugin::boot(__FILE__, 'modules', ['modules'], [__DIR__ . '/src']);
}, 5);
