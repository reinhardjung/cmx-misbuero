...
add_settings_field('rev_bank_enabled',__('Revolut', 'default'),__NAMESPACE__ . '\\cmx_field_checkbox','cmx_tab_banken','cmx_sec_banken',['key'   => 'rev_bank_enabled','label' => __('Ja, aktivieren', 'default'),]);
add_settings_field('rev_iban',__('IBAN', 'default'),__NAMESPACE__ . '\\cmx_field_text','cmx_tab_banken','cmx_sec_banken',['key' => 'rev_iban','placeholder' => 'CHxx xxxx xxxx xxxx xxxx x',]);
add_settings_field('rev_recipient',__('Empfänger', 'default'),__NAMESPACE__ . '\\cmx_field_text','cmx_tab_banken','cmx_sec_banken',['key' => 'rev_recipient','placeholder' => 'Name Deiner Firma',]);
add_settings_field('rev_bank_api',__('API', 'default'),__NAMESPACE__ . '\\cmx_field_text','cmx_tab_banken','cmx_sec_banken',['key' => 'rev_bank_api','placeholder' => '7f2d9b3a1c8e5f0d4a7c9e1234b6d8f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d',]);

add_settings_field('zkb_bank_enabled',__('ZKB', 'default'),__NAMESPACE__ . '\\cmx_field_checkbox','cmx_tab_banken','cmx_sec_banken',['key'   => 'zkb_bank_enabled','label' => __('Ja, aktivieren', 'default'),]);
add_settings_field('zkb_iban',__('IBAN', 'default'),__NAMESPACE__ . '\\cmx_field_text','cmx_tab_banken','cmx_sec_banken',['key' => 'zkb_iban','placeholder' => 'CHxx xxxx xxxx xxxx xxxx x',]);
add_settings_field('zkb_recipient',__('Empfänger', 'default'),__NAMESPACE__ . '\\cmx_field_text','cmx_tab_banken','cmx_sec_banken',['key' => 'zkb_recipient','placeholder' => 'Name Deiner Firma',]);
add_settings_field('zkb_bank_api',__('API', 'default'),__NAMESPACE__ . '\\cmx_field_text','cmx_tab_banken','cmx_sec_banken',['key' => 'zkb_bank_api','placeholder' => '7f2d9b3a1c8e5f0d4a7c9e1234b6d8f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d',]);

add_settings_field('ubs_bank_enabled',__('UBS', 'default'),__NAMESPACE__ . '\\cmx_field_checkbox','cmx_tab_banken','cmx_sec_banken',['key'   => 'ubs_bank_enabled','label' => __('Ja, aktivieren', 'default'),]);
add_settings_field('ubs_iban',__('IBAN', 'default'),__NAMESPACE__ . '\\cmx_field_text','cmx_tab_banken','cmx_sec_banken',['key' => 'ubs_iban','placeholder' => 'CHxx xxxx xxxx xxxx xxxx x',]);
add_settings_field('ubs_recipient',__('Empfänger', 'default'),__NAMESPACE__ . '\\cmx_field_text','cmx_tab_banken','cmx_sec_banken',['key' => 'ubs_recipient','placeholder' => 'Name Deiner Firma',]);
add_settings_field('ubs_bank_api',__('API', 'default'),__NAMESPACE__ . '\\cmx_field_text','cmx_tab_banken','cmx_sec_banken',['key' => 'ubs_bank_api','placeholder' => '7f2d9b3a1c8e5f0d4a7c9e1234b6d8f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d',]);
