...
<?php if (!empty($tpl['document']['subject'])): ?>
	<p><strong><?= htmlspecialchars($tpl['document']['subject'], ENT_QUOTES, 'UTF-8'); ?></strong></p>
<?php endif; ?>
...
<table>
	...
	<?php if (!empty($tpl['positions'])): ?>
		<?php foreach ($tpl['positions'] as $row): ?>
			<tr class="position">
				...
				<td class="text-right">
					<?= htmlspecialchars(number_format((float)($row['qty'] ?? 0), 2, $tpl['format']['decimal'], $tpl['format']['thousands']), ENT_QUOTES, 'UTF-8'); ?>
				</td>
				<td class="text-right">
					<?= htmlspecialchars(number_format((float)($row['unit_price'] ?? 0), $tpl['format']['decimals'], $tpl['format']['decimal'], $tpl['format']['thousands']), ENT_QUOTES, 'UTF-8'); ?>
				</td>
				<td class="text-right">
					<?= htmlspecialchars(number_format((float)($row['line_total'] ?? 0), $tpl['format']['decimals'], $tpl['format']['decimal'], $tpl['format']['thousands']), ENT_QUOTES, 'UTF-8'); ?>
				</td>
			</tr>
		<?php endforeach; ?>
	<?php else: ?>
	...
	<tr>
		...
		<td class="total text-right">
			<strong><?= htmlspecialchars(number_format((float)($tpl['document']['total'] ?? $tpl['document']['subtotal'] ?? 0), $tpl['format']['decimals'], $tpl['format']['decimal'], $tpl['format']['thousands']), ENT_QUOTES, 'UTF-8'); ?></strong>
