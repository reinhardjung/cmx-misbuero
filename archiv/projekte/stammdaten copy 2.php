 ...
 * - Anzeige: SIDE
 * - Namespace-sicher (Closures statt globaler Funktionsnamen)
 */
...
// Helper: ISO-Datum (YYYY-MM-DD) hart prüfen
...
add_action('add_meta_boxes', function() {
	...
	// Falls doppelt vorhanden, vorher löschen
	add_meta_box(
		'cmx_projekt_stammdaten', // neue ID
