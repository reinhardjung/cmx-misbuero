...
// var_dump($htmlspecialchars($tpl['branding']['logo'])); exit;
// var_dump($tpl['me']); exit;
?>
...
<div class="footer" style="font-size:xx-small; color:grey;">
	...
	<tr>
		...
		<td style="text-align:center;">
			...
			<?= cmx_get_standard_bank_data()['bank_name']; ?><br>
			<?= cmx_get_standard_bank_data()['iban']; ?><br>
		</td>
		<td style="text-align:right;">
			<b><?= htmlspecialchars($tpl['labels']['contact'] ?? 'Kontakt', ENT_QUOTES, 'UTF-8'); ?></b><br>
			<?php if (!empty($tpl['me']['phone'])): ?>
				<a href="https://misbuero.ch/index.php/call/<?= urlencode(str_replace(' ', '+', $tpl['me']['phone'])); ?>"><?= htmlspecialchars($tpl['me']['phone'], ENT_QUOTES, 'UTF-8'); ?></a><br>
				<a href="https://misbuero.ch/call.php?num=<?= urlencode($tpl['me']['phone']); ?>"><?= htmlspecialchars($tpl['me']['phone'], ENT_QUOTES, 'UTF-8'); ?></a>
...
<!-- <a href="https://misbuero.ch/call/?= urlencode($tpl['me']['phone']); ?>"><= htmlspecialchars($tpl['me']['phone'], ENT_QUOTES, 'UTF-8'); ?></a><br> -->
