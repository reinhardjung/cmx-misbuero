		...
		function($post) use ($screen) {
			...
			if ($show_actions) {
				...
				if ($is_pending_belegeingang) {
					...
					if ($delete_link || $dup_link !== '' || $new_beleg_url !== '' || $new_beleg_from_artikel_url !== '' || $new_beleg_from_carent_url !== '' || $artikel_katalog_icon_html !== '' || $carent_vertrag_icon_html !== '' || $carent_vertrag_pdf_icon_html !== '' || $show_pdf_icons || $belegeingang_confirm_url !== '' || $kontakt_belege_url !== '' || $kontakt_telefonbuch_url !== '' || $kontakt_zugangsdaten_url !== '') {
