...
function cmx_layout_defaults_builtin(): array {
	return [
		...
		'meta-box-order_belege' => [
			'side' => 'cmx_savebox,cmx-beleg-abo,cmx_beleg_summe_box,cmx_beleg_waehrung,cmx_beleg_anzahlungen,cmx_belege_mwst_box,belege_zahlungsgrunddiv,cmx_uploads_box,cmx_dokumente_box',
