...
final class Presets {
	...
	public static function defaults(string $industry = 'dienstleister'): array {
		...
		return [
			...
			'opening_hours' => self::opening_hours_defaults(),
		];
	}
	...
	public static function content_preset(string $industry): array {
		...
		return [
			'hero' => $preset['hero'],
			'hero_points' => $preset['hero_points'],
	...
	private static function opening_hours_defaults(): array {
		return [
			'enabled' => '1',
			'kicker' => __('Öffnungszeiten', 'cmx-misbuero'),
			'title' => __('Wann wir für Sie da sind', 'cmx-misbuero'),
			'subtitle' => '',
			'days' => [
				'mon' => [],
				'tue' => [],
	...
	private static function preset(string $industry): array {
		...
		return [
			...
			'hero_points' => [
				['icon' => 'shield', 'title' => __('Erfahren & kompetent', 'cmx-misbuero'), 'text' => ''],
				['icon' => 'check', 'title' => __('Zuverlässig & termintreu', 'cmx-misbuero'), 'text' => ''],
				['icon' => 'star', 'title' => __('Individuelle Lösungen', 'cmx-misbuero'), 'text' => ''],
			],
			'services' => [
				'enabled' => '1',
			...
			'articles' => [
				'enabled' => '0',
				'kicker' => __('Artikel', 'cmx-misbuero'),
				'title' => __('Ausgewählte Artikel', 'cmx-misbuero'),
				'subtitle' => __('Eine Auswahl passender Artikel und Varianten im Überblick.', 'cmx-misbuero'),
			],
			'about' => [
				'enabled' => '1',
			...
			'contact' => [
				...
				'button_url' => '',
				'thank_you_text' => __('Vielen Dank für die Nachricht – wir kümmern uns darum.', 'cmx-misbuero'),
			],
		];
	}
	...
	private static function support_email(): string {
		$email = \function_exists('CLOUDMEISTER\\CMX\\Buero\\cmx_misbuero_support_email')
			? (string) \CLOUDMEISTER\CMX\Buero\cmx_misbuero_support_email()
			: 'support@misbuero.ch';
