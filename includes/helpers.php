...
if (!\function_exists(__NAMESPACE__ . '\\cmx_misbuero_migrate_support_email_defaults')) {
	function cmx_misbuero_migrate_support_email_defaults(): void {
		...
		if (\get_option($settings_key . '__flat', null) !== null) {
			...
			if (\strtolower($flat_website_email) === 'wp.admin@misbuero.ch') {
			...
			if (\strtolower($flat_button_url) === 'mailto:wp.admin@misbuero.ch') {
		...
		if (\strtolower($website_email) === 'wp.admin@misbuero.ch') {
		...
		if (\strtolower($button_url) === 'mailto:wp.admin@misbuero.ch') {
