...
function inject_styles(): void {
	...
	body.admin-color-misbuero_admin_red {
		...
		--mb-nav-bg: #1e242c;
		--mb-nav-bg-dark: #171c23;
		--mb-nav-surface: rgba(255, 255, 255, 0.05);
		--mb-nav-surface-strong: rgba(255, 255, 255, 0.08);
		--mb-nav-text: #dce3ec;
		--mb-nav-muted: #a8b3c2;
		--mb-nav-active: linear-gradient(180deg, rgba(164, 44, 36, 0.96) 0%, rgba(127, 31, 26, 0.94) 100%);
	}
	...
	/* Ruhigere, hochwertigere WP-Admin-Navigation */
	#adminmenuback,
	#adminmenuwrap {
		background: linear-gradient(180deg, var(--mb-nav-bg) 0%, var(--mb-nav-bg-dark) 100%) !important;
	...
	#adminmenu div.wp-menu-image:before {
		font-size: 18px;
		line-height: 32px;
		color: var(--mb-nav-muted) !important;
		transition: color 160ms ease;
	}
	#adminmenu a,
	#adminmenu div.wp-menu-name,
	#adminmenu .wp-submenu a {
		color: var(--mb-nav-text) !important;
	}
	#adminmenu div.wp-menu-name {
		padding: 0 !important;
		font-size: 13.5px;
	...
	#adminmenu li.menu-top > a.menu-top:hover,
	#adminmenu li.wp-menu-open > a.menu-top,
	#adminmenu li.wp-has-current-submenu > a.menu-top,
	#adminmenu li.current > a.menu-top {
		background: var(--mb-nav-active) !important;
		color: #fff !important;
		box-shadow:
			0 10px 22px rgba(0, 0, 0, 0.24),
			inset 0 0 0 1px rgba(255, 235, 59, 0.18);
	}
	#adminmenu li.menu-top > a.menu-top:hover .wp-menu-image:before,
	#adminmenu li.wp-menu-open > a.menu-top .wp-menu-image:before,
	#adminmenu li.wp-has-current-submenu > a.menu-top .wp-menu-image:before,
	...
	#adminmenu .wp-submenu li.current a:hover {
		background: rgba(164, 44, 36, 0.22) !important;
		color: #fff !important;
	}
	...
	#adminmenu li.menu-top .awaiting-mod,
	#adminmenu li.menu-top .update-plugins {
		border-radius: 999px;
		border: 0;
...
add_action('admin_head', function (): void {
	...
	?>
	<style id="cmx-admin-navigation-skin">
	body.wp-admin {
		--cmx-nav-bg: #1e242c;
		--cmx-nav-bg-dark: #171c23;
		--cmx-nav-text: #dce3ec;
		--cmx-nav-muted: #a8b3c2;
		--cmx-nav-accent: #a42c24;
		--cmx-nav-accent-dark: #7f1f1a;
		--cmx-nav-accent-text: #ffeb3b;
		--cmx-nav-active: linear-gradient(180deg, rgba(164, 44, 36, 0.96) 0%, rgba(127, 31, 26, 0.94) 100%);
	}
	#adminmenuback,
	#adminmenuwrap {
		background: linear-gradient(180deg, var(--cmx-nav-bg) 0%, var(--cmx-nav-bg-dark) 100%) !important;
		box-shadow: inset -1px 0 0 rgba(255, 255, 255, 0.05);
	}
	#adminmenu,
	#adminmenu .wp-submenu,
	...
	#adminmenu div.wp-menu-image:before {
		font-size: 18px;
		line-height: 32px;
		color: var(--cmx-nav-muted) !important;
		transition: color 160ms ease;
	}
	#adminmenu a,
	#adminmenu div.wp-menu-name,
	#adminmenu .wp-submenu a {
		color: var(--cmx-nav-text) !important;
	}
	#adminmenu div.wp-menu-name {
		padding: 0 !important;
		font-size: 13.5px;
	...
	#adminmenu li.wp-has-current-submenu > a.menu-top,
	#adminmenu li.current > a.menu-top {
		background: var(--cmx-nav-active) !important;
		color: #fff !important;
		box-shadow:
			0 10px 22px rgba(0, 0, 0, 0.24),
			inset 0 0 0 1px rgba(255, 235, 59, 0.18);
	...
	#adminmenu li.wp-has-current-submenu > a.menu-top .wp-menu-image:before,
	#adminmenu li.current > a.menu-top .wp-menu-image:before {
		color: var(--cmx-nav-accent-text) !important;
	}
	#adminmenu .wp-submenu {
		margin: 8px 8px 10px 10px;
		padding: 8px 0;
