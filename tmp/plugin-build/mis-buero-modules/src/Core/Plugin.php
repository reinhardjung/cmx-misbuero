...
final class Plugin {
	...
	public function register_common_hooks(): void {
		\do_action('mis_buero/core/init', $this->variant);
	}
	...
	public function load_modules(): void {
		...
		\do_action('mis_buero/modules/before_load', $modules, $this->variant);
		(new ModuleLoader($this->module_dirs))->load($modules);
		\do_action('mis_buero/modules/loaded', $modules, $this->variant);
	}
